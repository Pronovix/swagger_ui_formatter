...
/**
 * Tests the unsupported version message rendering in field formatters.
 *
 * @internal This class is not part of the module's public programming API.
 */
final class SwaggerUiFieldFormatterUnsupportedVersionTest extends WebDriverTestBase {

  /**
   * {@inheritdoc}
   */
  protected static $modules = ['swagger_ui_formatter_test', 'swagger_ui_formatter_test_fake_discovery'];
  ...
  private function validateSwaggerUiErrorMessage(string $filename_prefix): void {
    ...
    /** @var \Drupal\swagger_ui_formatter_test_fake_discovery\Service\SwaggerUiLibraryDiscovery $swagger_ui_library_discovery */
    ...
    // @see \Drupal\swagger_ui_formatter_test\Service\SwaggerUiLibraryDiscoveryFromDownloadedArtifact::flushCaches()
