...
(function ($) {
  Drupal.behaviors.swagger_ui_formatter = {
    attach: function (context, settings) {
      ...
      var formatter = settings.swagger_ui_formatter;
      // Iterate over fields and render each field item with Swagger UI.
      for (var fieldItem in formatter.swagger_fields) {
        if (formatter.swagger_fields.hasOwnProperty(fieldItem)) {
          ...
          var swaggerOptions = {
            ...
            presets: [
              ...
              formatter.show_top_bar ? SwaggerUIStandalonePreset : SwaggerUIStandalonePreset.slice(1)
            ],
            plugins: [
              SwaggerUIBundle.plugins.DownloadUrl
            ],
            validatorUrl: formatter.validator_url,
